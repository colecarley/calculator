...
#[test]
fn test_add() {
    let input = "let x = 6; let y = 6; x + y;".to_string();
    assert_eq!(evaluate(input), Value::Number(12));
}

#[test]
fn test_sub() {
    let input = "let x = 24; let y = 12; x - y;".to_string();
    assert_eq!(evaluate(input), Value::Number(12));
}

#[test]
fn test_div() {
    let input = "let x = 24; let y = 2; x / y;".to_string();
    assert_eq!(evaluate(input), Value::Number(12));
}

#[test]
fn test_mult() {
    let input = "let x = 6; let y = 2; x * y;".to_string();
    assert_eq!(evaluate(input), Value::Number(12));
}
...
fn test_equality_with_strings() {
    let input = "let x = \"hello\"; let y = \"hello\"; x == y;".to_string();
    assert_eq!(evaluate(input), Value::Boolean(true));
}

#[test]
fn test_equality_with_booleans() {
    let input = "let x = true; let y = true; x == y;".to_string();
    assert_eq!(evaluate(input), Value::Boolean(true));
}

#[test]
fn test_inequality_with_numbers() {
    let input = "let x = 6; let y = 12; x != y;".to_string();
    assert_eq!(evaluate(input), Value::Boolean(true));
}

#[test]
fn test_inequality_with_strings() {
    let input = "let x = \"hello\"; let y = \"world\"; x != y;".to_string();
    assert_eq!(evaluate(input), Value::Boolean(true));
}

#[test]
fn test_inequality_with_booleans() {
    let input = "let x = true; let y = false; x != y;".to_string();
    assert_eq!(evaluate(input), Value::Boolean(true));
}

#[test]
fn test_greater_than() {
    let input = "let x = 12; let y = 6; x > y;".to_string();
    assert_eq!(evaluate(input), Value::Boolean(true));
}
...
fn test_assignment_with_expression() {
    let input = "let x = 6; let y = x + 6; y;".to_string();
    assert_eq!(evaluate(input), Value::Number(12));
}
...
fn test_assignment_with_string() {
    let input = "let x = \"hello\"; x;".to_string();
...
fn test_function_declaration_with_recursion() {
    let input =
        "funk factorial(x) { if (x == 0) { 1; } else { x * factorial(x - 1); } } factorial(5);"
            .to_string();
...
fn test_function_declaration_with_nested_function() {
    let input = "funk add(x, y) { funk add2(x, y) { x + y; } add2(x, y); } add(6, 6);".to_string();
    assert_eq!(evaluate(input), Value::Number(12));
}
...
fn test_higher_order_function() {
    let input =
        "funk add(x, y) { x + y; } funk apply(f, x, y) { f(x, y); } apply(add, 6, 6);".to_string();
    assert_eq!(evaluate(input), Value::Number(12));
}

#[test]
fn test_indexing() {
    let input = "let x = [1, 2, 3]; x[0];".to_string();
    assert_eq!(evaluate(input), Value::Number(1));
}

#[test]
fn test_indexing_with_expression() {
    let input = "let x = [1, 2, 3]; x[1 + 1];".to_string();
    assert_eq!(evaluate(input), Value::Number(3));
}

#[test]
fn test_indexing_with_function_call() {
    let input = "funk one() { 1 }; let x = [1,2,3]; x[one()]".to_string();
...
fn test_single_line_comment() {
    let input = "let x = 6; // this is a comment\nx;".to_string();
    assert_eq!(evaluate(input), Value::Number(6));
}

#[test]
fn test_multi_line_comment() {
    let input = "let x = 6; /* this is a\nmulti-line\ncomment */ x;".to_string();
    assert_eq!(evaluate(input), Value::Number(6));
}
...
#[test]
fn test_is_function() {
    let input = "funk add(x, y) { x + y; } is_function(add)".to_string();
    assert_eq!(evaluate(input), Value::Boolean(true));
}
...
#[test]
fn test_fibonacci() {
    let input = "funk fibonacci(x) { if (x == 0) { 0; } else { if (x == 1) { 1; } else { fibonacci(x - 1) + fibonacci(x - 2); } } } fibonacci(10);".to_string();
    assert_eq!(evaluate(input), Value::Number(55));
}

#[test]
fn test_fibonacci_with_tail_call_optimization() {
    let input = "funk fibonacci(x) { funk fib(x, a, b) { if (x == 0) { a; } else { fib(x - 1, b, a + b); } } fib(x, 0, 1); } fibonacci(10);".to_string();
    assert_eq!(evaluate(input), Value::Number(55));
}
